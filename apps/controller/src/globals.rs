...
//     // w.settings.server.ca_server = mca_ip.unwrap_or_else(||
//     // DEFAULT_CA.to_string()); w.settings.server.dns_server =
//     // mdns_info.unwrap_or_else(|| DEFAULT_DNS.to_string());
