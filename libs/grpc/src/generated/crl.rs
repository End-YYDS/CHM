...
pub mod crl_client {
    ...
    impl CrlClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut().insert(GrpcMethod::new("crl.Crl", "ListCrlEntries"));
...
pub mod crl_server {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for CrlServer<T>
    where
        T: Crl,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/crl.Crl/ListCrlEntries" => {
                    ...
                    let fut = async move {
                        let method = ListCrlEntriesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "crl.Crl";
    impl<T> tonic::server::NamedService for CrlServer<T> {
